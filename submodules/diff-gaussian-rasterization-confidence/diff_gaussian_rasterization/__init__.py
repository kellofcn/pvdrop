...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        use_metric = raster_settings.use_metric
        if use_metric == None:
            use_metric = False
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, depth, alpha, radii, geomBuffer, binningBuffer, imgBuffer, accum_metric_counts = _C.rasterize_gaussians(*args)
        ...
        return color, radii, depth, alpha, accum_metric_counts

    @staticmethod
    def backward(ctx, grad_color, grad_radii, grad_depth, grad_alpha, grad_metric):
